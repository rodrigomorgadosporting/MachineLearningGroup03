...
Data Source:
The dataset contains information regarding car attributes (brand, engine, year, etc.) and their selling prices).

Results & Methodology:
We utilized a blending strategy of tree-based models. The final model weights used for the submission were. This approach allowed us to balance the variance and bias of the individual models to minimize the Mean Absolute Error (MAE).
